...
#include "meta/db/database/serialisation.hpp"
#include "meta/db/database/file_header.hpp"
#include "meta/db/database/object_loader.hpp"

#include <set>

namespace mega::io
{
bool MetaStashEnvironment::restore( const CompilationFilePath& filePath, task::DeterminantHash hashCode ) const
{
