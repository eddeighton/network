...
public:
    ...
    public:
        ...
        Connection( Client&    client,
            ...
            , m_strand(
                  boost::asio::make_strand( client.m_io_context ) )
            , m_socket( m_strand )
            , m_sender( m_socket )
        {
            LOG_CLIENT( "Connection ctor start" );
            Resolver::query query(
                m_ip_address.value, m_port_number.str() );
            ...
            LOG_CLIENT( "Connection ctor complete "
                        << m_socket_info );
        }
    ...
    public:
        ...
        // connection is ALWAYS to a daemon so is always process ID
        // zero.
    ...
    Connection::Ptr connect( IPAddress  ip_address,
                             PortNumber port_number )
    {
