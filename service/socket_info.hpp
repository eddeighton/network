...
namespace mega::service
{
    struct TCPSocketInfo
    {
        ...
        static inline TCPSocketInfo make(const boost::asio::ip::tcp::socket& socket)
        {
            return
            {
    ...
    inline std::ostream& operator<<( std::ostream& os, const TCPSocketInfo& info )
    {
        return os <<
            "Local Endpoint: " << info.local_endpoint << 
