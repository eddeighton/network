...
public:
     ...
     * func(yield[myec]);
     * @endcode
     * @c yield[myec] returns an instance of @c yield_t whose @c ec_
     * points to @c myec. The expression @c yield[myec] "binds" @c
     * myec to that (anonymous) @c yield_t instance, instructing @c
     * func() to store any
     * @c error_code it might produce into @c myec rather than
     * throwing @c boost::system::system_error.
     */
